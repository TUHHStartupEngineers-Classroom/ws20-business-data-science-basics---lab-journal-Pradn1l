...
Comments about 3rd: I was able to build the logic for the code and I have the code too, however everytime I ran it my Rstudio crashed, so I was unable to attach it to the journal
...
The best I could was truncate the Assingmnet 3 from my journal for better performance.

I have the code which I could provide through mail.
